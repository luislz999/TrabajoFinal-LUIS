...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="nav navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:white;">UNIDAD 1</a>
    ...
    <div class="jumbotron">
        <h1 class="page-title">PAGINA DE MOSTRAR DATOS</h1>
        ...
        echo "Conexión exitosa a la base de datos de música";
        ...
        <div class="container table-container">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td> <img src="/<?php echo $fila['portada']; ?>" width="100" alt="Portada del álbum"></td>
                </tr>
                <?php endwhile; ?>
            </table>
            <?php else: ?>
